                        ...
                        try {
                            ...
                            for (int i = 0; i < jsonArray.length(); i++) {
                                ...
                                if(jsonObject1.getBoolean("selected")==true){
                                    ...
                                    TextView complete_address = (TextView)findViewById(R.id.tv2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_add_address.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent1 = new Intent(getApplicationContext(),AddAddress.class);
        ...
        adapter1 = new AddressAdapter(getApplicationContext(),placesList,auth_token);
